# -*- coding: utf-8 -*-
"""
Created on Thu Jun  2 13:35:54 2022
...
class Arduino_Device(Device):
    """A labscript_device for the Arduino using a visa interface.
    ...
    """
    description = 'General Arduino Device'
    ...
    def generate_code(self, hdf5_file):
        ...
        #instead of passing here, the device could be added to the h5 file