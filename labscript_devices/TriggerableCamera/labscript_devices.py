#####################################################################
#                                                                   #
# /labscript_devices/TriggerableCamera/labscript_devices.py         #
#                                                                   #
...
class TriggerableCamera(TriggerableDevice):
    description = 'Triggerable Camera'
    ...
    def __init__(
        ...
        **kwargs
        ...
        This is the generic camera device: it holds the structure every camera
        shares -- exposures, triggering, attributes and where images are stored
        in the shot file -- and knows nothing about any particular camera API.
        A camera for a given API is a subclass of this that names its interface
        class in the corresponding BLACS worker.
